...
SET scenariosrunning(scenarios) /Scenario1*Scenario90/;
...
$ifi %HEATTRANS%==yes  $ifi %HeatTransInvest%==yes   VXHKN.UP(Y,IAE,IAI)$SUM(IYALIAS$(IYALIAS.VAL LE Y.VAL),IXHKN(IYALIAS,IAE,IAI))= INF;
$ifi %HEATTRANS%==yes  $ifi %HeatTransInvest%==yes   VXHKNACCUMNET.UP(Y,IAE,IAI)$SUM(IYALIAS$(IYALIAS.VAL LE Y.VAL),IXHKN(IYALIAS,IAE,IAI))= INF;
$ifi %HYDROGEN%==yes  $ifi %H2TransInvest%==yes   VXH2KN.UP(Y,IRE,IRI)$SUM(IYALIAS$(IYALIAS.VAL LE Y.VAL),IX2HKN(IYALIAS,IRE,IRI))= INF;
$ifi %HYDROGEN%==yes  $ifi %H2TransInvest%==yes   VXH2KNACCUMNET.UP(Y,IRE,IRI)$SUM(IYALIAS$(IYALIAS.VAL LE Y.VAL),IXH2KN(IYALIAS,IRE,IRI))= INF;
$ifi %HYDROGEN%==yes  $ifi %H2TransInvest%==yes   VXH2KN_NGTOH2.UP(Y,IRE,IRI)$SUM(IYALIAS$(IYALIAS.VAL LE Y.VAL),IX2HKN_NGTOH2(IYALIAS,IRE,IRI))= INF;
$ifi %HYDROGEN%==yes  $ifi %H2TransInvest%==yes   VXH2KNACCUMNET_NGTOH2.UP(Y,IRE,IRI)$SUM(IYALIAS$(IYALIAS.VAL LE Y.VAL),IXH2KN_NGTOH2(IYALIAS,IRE,IRI))= INF;
...
$ifi %HEATTRANS%==yes  $ifi %HeatTransInvest%==yes   VXHKN.LO(Y,IAE,IAI)$SUM(IYALIAS$(IYALIAS.VAL LE Y.VAL),IXHKN(IYALIAS,IAE,IAI))= 0;
$ifi %HEATTRANS%==yes  $ifi %HeatTransInvest%==yes   VXHKNACCUMNET.LO(Y,IAE,IAI)$SUM(IYALIAS$(IYALIAS.VAL LE Y.VAL),IXHKN(IYALIAS,IAE,IAI))= 0;
$ifi %HYDROGEN%==yes  $ifi %H2TransInvest%==yes   VXH2KN.LO(Y,IRE,IRI)$SUM(IYALIAS$(IYALIAS.VAL LE Y.VAL),IX2HKN(IYALIAS,IRE,IRI))= 0;
$ifi %HYDROGEN%==yes  $ifi %H2TransInvest%==yes   VXH2KNACCUMNET.LO(Y,IRE,IRI)$SUM(IYALIAS$(IYALIAS.VAL LE Y.VAL),IXH2KN(IYALIAS,IRE,IRI))= 0;
$ifi %HYDROGEN%==yes  $ifi %H2TransInvest%==yes   VXH2KN_NGTOH2.LO(Y,IRE,IRI)$SUM(IYALIAS$(IYALIAS.VAL LE Y.VAL),IX2HKN_NGTOH2(IYALIAS,IRE,IRI))= 0;
$ifi %HYDROGEN%==yes  $ifi %H2TransInvest%==yes   VXH2KNACCUMNET_NGTOH2.LO(Y,IRE,IRI)$SUM(IYALIAS$(IYALIAS.VAL LE Y.VAL),IXH2KN_NGTOH2(IYALIAS,IRE,IRI))= 0;
